...
public class PeptideViewerSortingPanel {
    ...
    public static final String SCORE_PREFIX = ReportPeptideComparatorFactory.SCORE_PREFIX;
    ...
    public void changeSorting(Long fileID, String property) {
        List<String> orderedSortOrders = fileSortPriorities.get(fileID);
        for (Map.Entry<String, SortOrder> entry : fileSortings.get(fileID).entrySet()) {
            SortOrder newOrder;
    ...
    public Comparator<ReportPeptide> getPeptideComparator(String property) {
        return ReportPeptideComparatorFactory.getComparatorByName(property, SortOrder.ascending);
    }
