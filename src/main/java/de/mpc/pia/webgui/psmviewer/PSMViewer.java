...
public class PSMViewer {
     ...
     * @param spectraMap
     */
    public PSMViewer(PSMModeller modeller, PIAModeller piaModeller) {
        ...
        exportPanelHandler = new PSMViewerExportPanel(psmModeller, piaModeller);
    ...
    public String convertScore(Double score) {
        ...
        if ((score != null) && !score.equals(Double.NaN)) {
            if (!score.equals(0.0)
                ...
                scoreString = scoreDfVerySmall.format(score);
            } else {
                scoreString = scoreDfNormal.format(score);
            }
        } else {
            if (score == null) {
                scoreString = null;
